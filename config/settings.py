...
MIDDLEWARE = [
    ...
    "accounts.middleware.TemporaryStudentAccessMiddleware",
...
OPENAI_DEFAULT_INPUT_PRICE_PER_MILLION = Decimal(
    env("OPENAI_DEFAULT_INPUT_PRICE_PER_MILLION", default="1.00")
)
OPENAI_DEFAULT_OUTPUT_PRICE_PER_MILLION = Decimal(
    env("OPENAI_DEFAULT_OUTPUT_PRICE_PER_MILLION", default="6.00")
)
OPENAI_DEFAULT_PRICING_CURRENCY = env("OPENAI_DEFAULT_PRICING_CURRENCY", default="USD")
OPENAI_RESERVE_MAX_OUTPUT_TOKENS = env.int("OPENAI_RESERVE_MAX_OUTPUT_TOKENS", default=8_000)
